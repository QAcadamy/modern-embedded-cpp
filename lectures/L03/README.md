...
## Agenda
* Inheritance for creating classes that build upon existing classes.
...
## Prerequisites
* Basic familiarity with C++ (classes, constructors, const).

## Instructions

### Preparation
* Read about inheritance in [Appendix A](./appendix/a_inheritance.md).
