...
## Files
* [driver/led/interface.hpp](./include/driver/led/interface.hpp) constitutes the interface itself in the form of the base class `driver::led::Interface`.
* [driver/led/atmega328p.hpp](./include/driver/led/atmega328p.hpp) constitutes an implementation of LEDs for the processor `ATmega328P` via the subclass `driver::led::Atmega328p`:
    * The corresponding source code can be found [here](./source/driver/led/atmega328p.cpp).
* [driver/led/esp32s3.hpp](./include/driver/led/esp32s3.hpp) constitutes an implementation of LEDs for the processor `ESP32-S3` via the subclass `driver::led::Esp32s3`:
