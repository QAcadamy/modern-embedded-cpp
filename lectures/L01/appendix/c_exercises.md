...
* Create a loop that runs for `5000` iterations:
  ...
  * Call `hasTimedOut()` to check whether the timer has expired.
...
Implement this function template in the same anonymous namespace as Exercise 4.1.
